...
def do_Hydrogen():
    ...
    print("HF Energies (H):\n\tE_0 = %1.3f a.u. (EXACT = 0.500)" % (eigvals[0]) )
...
def do_H2_Hartree():
    ...
    print("Hartree Energy (H2):\n\tE_0 = %1.3f a.u." % (Eg + 1) )
    #print(C)


def do_H2_HartreeFock():
    #########################################################################
    ...
    print("Hartree-Fock Energy (H2):\n\tE_0 = %1.3f a.u." % (Eg + 1) )# +1 for nuclear repulsion energy
